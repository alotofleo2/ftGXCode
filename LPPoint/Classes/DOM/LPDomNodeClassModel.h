...
@property (nonatomic, copy) NSString *nodeCode;                                // 节点的唯一标识符
...
@property (nonatomic, weak) LPDomNodeClassModel *rootNode;                     // 根节点弱引用,如是根节点此为nil
@property (nonatomic, strong) NSHashTable<LPDomNodeModel *> *nodeModels;       // 与此节点对应的视图的节点模型
@property (nonatomic, strong) NSMutableArray<LPDomNodeClassModel *> *childs;   // 此节点的子节点
